...
const MeetingManagementApp = () => {
  ...
  // Salva current user in localStorage quando cambia
  useEffect(() => {
    localStorage.setItem('currentUser', currentUser);
  }, [currentUser]);

  // Salva partecipanti in localStorage quando cambiano
  useEffect(() => {
    localStorage.setItem('participants', JSON.stringify(participants));
  }, [participants]);

  // Salva topics in localStorage quando cambiano
  useEffect(() => {
    localStorage.setItem('topics', JSON.stringify(topics));
  }, [topics]);

  // Salva tasks in localStorage quando cambiano
  useEffect(() => {
